...
export default function InquiryForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.info('Przygotowuję pliki do wysłania...');
  ...
  const gardenTypes = [{ id: 'home-extension', name: 'Home Extension', desc: 'Rozszerzenie przestrzeni' },{ id: 'classic-warm', name: 'Ogród klasyczny', desc: 'Całoroczny, ogrzewany' },{ id: 'seasonal-cold', name: 'Ogród sezonowy', desc: 'Użytkowany w ciepłych miesiącach' },{ id: 'pergola', name: 'Pergola', desc: 'Otwarta konstrukcja' },{ id: 'not-sure', name: 'Nie wiem', desc: 'Pomoc w wyborze' }];
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-4xl mx-auto p-4 sm:p-8 relative bg-white rounded-2xl shadow-2xl border border-slate-200">
        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Planowany termin montażu</label>
